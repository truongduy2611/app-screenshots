...
mixin _$DeviceInfo {
  ...
  /// Optional PNG asset path for the portrait frame image.
  String? get frameAssetPath => throw _privateConstructorUsedError;

  /// Optional PNG asset path for the landscape frame image.
  String? get landscapeFrameAssetPath => throw _privateConstructorUsedError;
...
abstract class $DeviceInfoCopyWith<$Res> {
  ...
  $Res call(
      ...
      String? landscapeFrameAssetPath});
}
...
class _$DeviceInfoCopyWithImpl<$Res> implements $DeviceInfoCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? frameAssetPath = freezed,
    Object? landscapeFrameAssetPath = freezed,
  }) {
    return _then(_value.copyWith(
      ...
      screenSize: screenSize == freezed
          ...
          : screenSize // ignore: cast_nullable_to_non_nullable
              as Size,
      frameAssetPath: frameAssetPath == freezed
          ? _value.frameAssetPath
          : frameAssetPath // ignore: cast_nullable_to_non_nullable
              as String?,
      landscapeFrameAssetPath: landscapeFrameAssetPath == freezed
          ? _value.landscapeFrameAssetPath
          : landscapeFrameAssetPath // ignore: cast_nullable_to_non_nullable
              as String?,
    ));
  }
}
...
class _$_DeviceInfo with DiagnosticableTreeMixin implements _DeviceInfo {
  const _$_DeviceInfo(
      ...
      this.frameAssetPath = null,
      this.landscapeFrameAssetPath = null});
  ...
  @override
  @JsonKey()
  final String? landscapeFrameAssetPath;

  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'DeviceInfo(identifier: $identifier, name: $name, rotatedSafeAreas: $rotatedSafeAreas, safeAreas: $safeAreas, screenPath: $screenPath, pixelRatio: $pixelRatio, framePainter: $framePainter, frameSize: $frameSize, screenSize: $screenSize, frameAssetPath: $frameAssetPath, landscapeFrameAssetPath: $landscapeFrameAssetPath)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('frameAssetPath', frameAssetPath))
      ..add(DiagnosticsProperty(
          'landscapeFrameAssetPath', landscapeFrameAssetPath));
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.frameAssetPath, frameAssetPath) &&
            const DeepCollectionEquality().equals(
                other.landscapeFrameAssetPath, landscapeFrameAssetPath));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(frameAssetPath),
      const DeepCollectionEquality().hash(landscapeFrameAssetPath));
...
abstract class _DeviceInfo implements DeviceInfo {
  const factory _DeviceInfo(
      {required final DeviceIdentifier identifier,
      ...
      final String? frameAssetPath,
      final String? landscapeFrameAssetPath}) = _$_DeviceInfo;
